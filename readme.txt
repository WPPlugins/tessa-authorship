...
Lists for related authors or related posts on the authors page can be shown or automatically activating the content filter in the settings or you have to use for example:
...
* [Stripe For Easy Digital Downloads HTTPS](http://takebarcelona.com/stripe-for-easy-digital-downloads): A Stripe payment gateway for Easy Digital Downloads. Due date: 2014/05
* [WooCommerce Poor Guys Swiss Knife](http://takebarcelona.com/woocommerce-poor-guys-swiss-knife/): a great plugin to power-overload WooCommerce. Available on Wordpress with 15.000 downloads and counting
